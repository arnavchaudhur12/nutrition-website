...
class EmailService:
    ...
    def send_order_confirmation(self, buyer_email: str, subject: str, html_body: str) -> None:
        self._send_to_buyer_and_admin(buyer_email, subject, html_body)

    def send_payment_failure(self, buyer_email: str, subject: str, html_body: str) -> None:
        self._send_to_buyer_and_admin(buyer_email, subject, html_body)

    def _send_to_buyer_and_admin(self, buyer_email: str, subject: str, html_body: str) -> None:
        ...
        logger.info(
            "Email sent to recipients=%s subject=%s",
            recipients,
            subject,
        )
