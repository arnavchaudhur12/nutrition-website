                ...
                <article key={order.order_number} className="order-card">
                  ...
                  <div className="shipment-timeline">
                    {getShipmentTimeline(order).map((step) => (
                      <div
                        key={`${order.order_number}-${step.label}`}
                        className={[
                          "shipment-step",
                          step.done ? "done" : "",
                          step.active ? "active" : ""
                      ...
                      >
                        <span className="shipment-step-dot" />
                        <div>
                  ...
                  {order.shipment?.history?.length ? (
                    <div className="shipment-history">
                      {order.shipment.history.map((event, index) => (
                        <div key={`${order.order_number}-${event.status}-${event.timestamp ?? index}`} className="shipment-history-row">
                          <div>
